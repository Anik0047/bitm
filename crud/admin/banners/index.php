                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><?= $banner['title'];?></td>
                                <td><?= $banner['link'];?></td>
                                <td><a href="show.php?id=<?= $banner['id'];?>">Show</a> | <a href="edit.php?id=<?= $banner['id'];?>">Edit</a> | <a href="delete.php?id=<?= $banner['id'];?>" onclick="return confirm('Are you ready to delete this')" > Delete</a></td>
                            </tr>
